...
const server = http.createServer(function(req, res) {
  ...
  path = path.replace(/^\/+|\/+$/g, "");//starting or ending with back or forward slashes, replace to string.The slash in the end will be removed
  console.log(path);
  let qs = parsedURL.query;
  let headers = req.headers;
  let method = req.method.toLowerCase();

  //two event listeners for data and end events. For you to have the end you must have the data event, even though you have no data.
